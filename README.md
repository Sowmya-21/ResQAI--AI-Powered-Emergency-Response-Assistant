...
<p align="center">
  <img src="https://img.shields.io/github/stars/Sowmya-21/ResQAI--AI-Powered-Emergency-Response-Assistant?style=social"/>
  <img src="https://img.shields.io/github/forks/Sowmya-21/ResQAI--AI-Powered-Emergency-Response-Assistant?style=social"/>
  <img src="https://img.shields.io/github/license/Sowmya-21/ResQAI--AI-Powered-Emergency-Response-Assistant"/>
</p>
...
```mermaid
flowchart TD
A[User Activates SOS] --> B[AI Detects Emergency Type]
B --> C[Generates Instructions]
C --> D[Guides User Step-by-Step]
D --> E[Optional: Connect to Doctor]
```
